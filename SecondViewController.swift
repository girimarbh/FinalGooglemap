...
class SecondViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate, GMSAutocompleteViewControllerDelegate, UITextFieldDelegate {
...
//        leftmenu=LeftSideMenuView(frame: CGRect(x: 0.0, y: 50.0, width: 200, height: self.view.frame.size.height))
