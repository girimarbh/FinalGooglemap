...
//    }
    ...
    func setupViews() {
        ...
        containerView.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 10, paddingRight: 0, width: self.frame.size.width, height: 300, enableInsets:true)
...
//        containerView.bottomAnchor.constraint(equalTo: bottomAnchor).isActive=true
      ...
      //  loacatePlantbutton.addTarget(self, action: #selector(btnMyLocationAction), for: .touchUpInside)
...
//
    ...
    let loacatePlantbutton: UIButton = {
       ...
       // btn.setTitle(" locate Plant ", for: .normal)
        btn.setImage(UIImage(named: "button_location.png"), for: .normal)
